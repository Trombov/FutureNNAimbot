...
namespace FutureNNAimbot
{
    internal class TrainingApp
    {
        ...
        public void Run()
        {
            dh.DrawTraining(trainBox, settings, TrainingNames[selectedObject], screenshotMode);
        }
        ...
        public void ReadInput()
        {
            ...
            {
                selectedObject = (selectedObject + 1) % nn.TrainingNames.Length;
            }

            if (Util.IsKeyToggled(Keys.PageDown))
            {
                selectedObject = (selectedObject - 1 + nn.TrainingNames.Length) % nn.TrainingNames.Length;
            }
